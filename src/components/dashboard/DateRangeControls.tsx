...
export const DateRangeControls = React.memo(function DateRangeControls({
    ...
    const adaptiveGridClass = "w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 xl:grid-cols-2 gap-3 relative z-10";
                        ...
                        <div key={field} className="relative group w-full min-w-0">
                            ...
                            <div className="w-full overflow-hidden rounded-lg">
                                <input
                                    ...
                                    className="appearance-none w-full max-w-full block m-0 min-w-0 bg-slate-950/50 border border-slate-700/50 rounded-lg px-3 py-2 text-sm text-slate-200 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all shadow-inner box-border"
                                />
                            </div>
                        </div>
                    ))}
                        ...
                        <div key={field} className="relative group w-full min-w-0">
                            ...
                            <div className="w-full overflow-hidden rounded-lg">
                                <input
                                    ...
                                    className="appearance-none w-full max-w-full block m-0 min-w-0 bg-slate-950/50 border border-emerald-900/50 rounded-lg px-3 py-2 text-sm text-emerald-100 focus:outline-none focus:ring-2 focus:ring-emerald-500/40 focus:border-emerald-500/80 transition-all shadow-inner box-border"
                                />
                            </div>
                        </div>
                    ))}
