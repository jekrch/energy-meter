...
export const DateRangeControls = React.memo(function DateRangeControls({
    ...
    return (
        <div className="bg-slate-900 rounded-md border border-slate-800 p-3 sm:p-4 flex flex-col gap-3 shadow-sm hover:border-slate-700 transition-colors min-w-0">
                    ...
                    <div key={field} className="relative group w-full min-w-0">
                        ...
                        <div className="w-full overflow-hidden rounded-md relative">
                            <input
                                ...
                                className="appearance-none w-full max-w-full block m-0 min-w-0 bg-slate-950/50 border border-slate-700/50 rounded-md px-3 pr-10 text-sm text-slate-200 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all shadow-inner box-border h-11 leading-[2.75rem]"
                            />
                            <CalendarDays
